...
![Font Encode](documentation/encode-font1.png)
...
![HTML Teste Result](documentation/html-test.png)

CSS
No errors were found when passing through the official (Jigsaw) validator

![CSS Teste Result](documentation/css-test.png)

Lighthouse Scores

![Lighthouse Scores](documentation/lightgouse-score.png)
